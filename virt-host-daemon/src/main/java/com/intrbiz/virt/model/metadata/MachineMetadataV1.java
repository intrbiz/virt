package com.intrbiz.virt.model.metadata;
...
public class MachineMetadataV1
{
    ...
    private NetworkV2 network = new NetworkV2();
    ...
    public NetworkV2 getNetwork()
    {
        return network;
    }

    public void setNetwork(NetworkV2 network)
    {
    ...
    public MachineMetadataV1 withSSHKey(List<String> sshKeys)
    {
        for (String sshKey : sshKeys)
        {
            this.sshKeys.add(sshKey);
    ...
    public MachineMetadataV1 withNetwork(NetworkV2 network)
    {
        this.network = network;
        return this;
    }
